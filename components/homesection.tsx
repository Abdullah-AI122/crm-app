...
export default function WorkspaceTable() {
    ...
    const tabs = ["Workspace", "Recently Visited", "New Boards"];
    ...
    return (
        <div
            className="bg-[#f4f4f6] rounded-[24px] overflow-hidden h-full flex flex-col shadow-sm "
            onClick={() => {
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="text-left text-sm text-[#7c7c80] font-bold font-google-sans border-b border-gray-200/40">
                                        ...
                                        <th className="px-6 py-3 font-semibold text-center">Total Boards</th>
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-2 text-sm font-bold font-google-sans text-slate-800 text-center">
                                                    {workspace.totalBoards > 0 ? (
                                                        <span>{workspace.totalBoards}</span>
                                                    ) : (
                                                ...
                                                <td className="px-6 py-2 text-sm text-center">
                                                    <div className="relative inline-block text-left">
                                                        ...
                                                        {openMenu === workspace._id && (
                                                            <div
                                                                onClick={(e) => e.stopPropagation()}
                                                                className="absolute top-10 right-0 w-56 bg-white rounded-xl shadow-xl border border-gray-200 z-30 overflow-hidden text-left"
                                                            >
                                                                <button
                                                                    onClick={async () => {
                                                                        try {
                            ...
                            for (let i = 1; i <= Math.min(maxVisible, totalPages); i++) {
                                pages.push(
                                    <button
                                        ...
                                        className={`w-10 h-10 rounded-2xl transition cursor-pointer font-bold font-google-sans text-sm ${
                                            currentPage === i
                                                ? "bg-black text-white"
